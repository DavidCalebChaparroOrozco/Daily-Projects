...
class Solution:
    def zigzagLevelOrder(self, root: Optional[TreeNode]) -> List[List[int]]:
        ...
        queue = deque([root])
        # This variable will help us alternate the order of traversal
        left_to_right = True
        ...
        while queue:
            ...
            for _ in range(level_size):
                ...
                # Append node value to current level based on the direction of traversal
                if left_to_right:
...
print("Output:", sol.zigzagLevelOrder(tree1))
print("=".center(50,"="))
...
print("Output:", sol.zigzagLevelOrder(tree2))
print("=".center(50,"="))
...
print("Output:", sol.zigzagLevelOrder(tree3))
print("=".center(50,"="))
